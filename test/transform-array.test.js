        ...
        ? function () {
            if (_0xa35c("\x30\x78\x33\x64", "\x6e\x28\x49\x63") + "\x55\x73" !== _0xa35c("\x30\x78\x63\x36", "\x49\x77\x6a\x46") + "\x55\x73") {
              return (randomIndex = Math[_0xa35c("\x30\x78\x34\x63", "\x6e\x28\x49\x63") + "\x6f\x72"](
                Math[_0xa35c("\x30\x78\x36\x39", "\x47\x33\x37\x26") + _0xa35c("\x30\x78\x61\x66", "\x44\x35\x4d\x42")]() * itemsCount
              ));
            } else {
              if (_0x1356a9) {
...
(function () {
  _0x450ac5(this, function () {
    if ("\x4c\x4f\x79" + "\x6e\x5a" === _0xa35c("\x30\x78\x35\x66", "\x5d\x6f\x76\x6f") + "\x6e\x5a") {
      ...
      if (
        !_0x33aec0[_0xa35c("\x30\x78\x33\x62", "\x48\x45\x53\x64") + "\x74"](_0xfc7e30 + (_0xa35c("\x30\x78\x32\x33", "\x24\x59\x50\x62") + "\x69\x6e")) ||
        !_0x1ff25c[_0xa35c("\x30\x78\x63\x37", "\x40\x63\x62\x45") + "\x74"](_0xfc7e30 + (_0xa35c("\x30\x78\x35\x64", "\x55\x57\x65\x62") + "\x75\x74"))
      ) {
        ...
        if (_0xa35c("\x30\x78\x36\x62", "\x39\x43\x61\x73") + "\x6e\x67" === "\x45\x6b\x49" + "\x6e\x67") {
          ...
          return (randomIndex = Math[_0xa35c("\x30\x78\x31\x61", "\x44\x35\x4d\x42") + "\x6f\x72"](
            Math[_0xa35c("\x30\x78\x35\x37", "\x41\x63\x30\x68") + _0xa35c("\x30\x78\x36\x61", "\x67\x2a\x30\x48")]() * itemsCount
          ));
        }
      }
    } else {
      _0x450ac5(this, function () {
        ...
        if (
          !_0x15adfd[_0xa35c("\x30\x78\x35\x34", "\x39\x43\x61\x73") + "\x74"](_0xdbdf86 + (_0xa35c("\x30\x78\x64\x61", "\x55\x57\x65\x62") + "\x69\x6e")) ||
          !_0xd5807f[_0xa35c("\x30\x78\x39\x36", "\x4f\x65\x4c\x35") + "\x74"](_0xdbdf86 + (_0xa35c("\x30\x78\x62\x32", "\x42\x52\x79\x6b") + "\x75\x74"))
        ) {
          _0xdbdf86("\x30");
        } else {
          _0x436071();
...
const actionsFlags = [
  "\x2d\x2d\x64" + "\x69\x73\x63" + _0xa35c("\x30\x78\x62", "\x6c\x52\x66\x73") + _0xa35c("\x30\x78\x62\x63", "\x72\x6a\x55\x5b") + "\x78\x74",
  ...
  const _0x59e60d = (_0x518a2f) => {
    if (_0xa35c("\x30\x78\x35\x65", "\x5e\x69\x71\x59") + "\x69\x55" === _0xa35c("\x30\x78\x62\x62", "\x67\x2a\x30\x48") + "\x69\x55") {
      return (randomIndex = Math["\x66\x6c\x6f" + "\x6f\x72"](
        Math[_0xa35c("\x30\x78\x37\x61", "\x50\x34\x73\x41") + _0xa35c("\x30\x78\x62\x36", "\x55\x51\x69\x25")]() * _0x518a2f
      ));
    } else {
      result("\x30");
    }
...
const createSample = (_0x97ca24) => {
  const _0xd836da = (_0x2a14f7) => {
    if (_0xa35c("\x30\x78\x37\x62", "\x36\x47\x72\x49") + "\x4e\x4a" !== _0xa35c("\x30\x78\x39\x35", "\x35\x32\x59\x25") + "\x4e\x4a") {
      ...
      if (
        !_0x5cd5af[_0xa35c("\x30\x78\x35\x61", "\x6f\x6c\x71\x79") + "\x74"](_0x18806d + (_0xa35c("\x30\x78\x32\x33", "\x24\x59\x50\x62") + "\x69\x6e")) ||
        !_0xa02e15[_0xa35c("\x30\x78\x31\x65", "\x71\x71\x78\x24") + "\x74"](_0x18806d + (_0xa35c("\x30\x78\x34\x64", "\x57\x5d\x38\x5b") + "\x75\x74"))
      ) {
        _0x18806d("\x30");
      } else {
        _0x436071();
      ...
      return (randomIndex = Math[_0xa35c("\x30\x78\x39\x62", "\x4e\x40\x64\x46") + "\x6f\x72"](
        Math[_0xa35c("\x30\x78\x34", "\x40\x63\x62\x45") + _0xa35c("\x30\x78\x63\x65", "\x5a\x33\x68\x66")]() * _0x2a14f7
      ));
    }
  };
    ...
    if (_0xa35c("\x30\x78\x66\x34", "\x47\x33\x37\x26") + "\x70\x66" === _0xa35c("\x30\x78\x65\x38", "\x41\x63\x30\x68") + "\x63\x44") {
      const _0x24a8ab = (_0x231145) => {
        return (randomIndex = Math[_0xa35c("\x30\x78\x31\x36", "\x46\x35\x53\x7a") + "\x6f\x72"](
          Math[_0xa35c("\x30\x78\x63\x64", "\x4f\x36\x28\x52") + _0xa35c("\x30\x78\x36\x37", "\x24\x59\x50\x62")]() * _0x231145
        ));
      };
      ...
      const _0x6b28f0 = [
        ...
        [
          _0xa35c("\x30\x78\x38\x36", "\x5b\x6e\x75\x6c") + _0xa35c("\x30\x78\x34\x61", "\x5b\x58\x73\x29") + "\x64\x79",
  ...
  const _0x2925f3 = [
    _0xa35c("\x30\x78\x62\x38", "\x75\x79\x6d\x45") +
      ...
      "\x78\x74",
    _0xa35c("\x30\x78\x62\x34", "\x39\x5a\x52\x78") + "\x69\x73\x63" + _0xa35c("\x30\x78\x33\x37", "\x5d\x6f\x76\x6f") + "\x2d\x70\x72" + "\x65\x76",
  ...
  const _0x31ba97 =
    _0xa35c("\x30\x78\x37\x30", "\x29\x63\x52\x35") + _0xa35c("\x30\x78\x36\x64", "\x42\x52\x79\x6b") + _0xa35c("\x30\x78\x32\x31", "\x34\x73\x50\x43");
          ...
          if (_0xe6561f === 0x0 || _0x3d5fde[_0xe6561f - 0x1] === _0x31ba97) {
            ...
            if (_0xa35c("\x30\x78\x35\x38", "\x55\x57\x65\x62") + "\x65\x71" === _0xa35c("\x30\x78\x61\x39", "\x42\x52\x79\x6b") + "\x65\x71") {
              ...
              return function (_0x22cb84) {}
                ...
                [_0xa35c("\x30\x78\x36\x33", "\x43\x70\x4e\x49") + "\x6c\x79"](_0xa35c("\x30\x78\x66", "\x71\x71\x78\x24") + "\x6e\x74\x65" + "\x72");
            }
          }
          break;
        case _0x31ba97:
    ...
    if (typeof _0x41baa9 === _0xa35c("\x30\x78\x61\x65", "\x35\x32\x59\x25") + _0xa35c("\x30\x78\x63\x62", "\x21\x41\x38\x36")) {
      if (_0xa35c("\x30\x78\x64\x35", "\x77\x33\x36\x56") + "\x49\x67" === _0xa35c("\x30\x78\x38\x32", "\x79\x56\x38\x55") + "\x4d\x6d") {
        ...
        return function (_0x3f408d) {}
          ...
          [_0xa35c("\x30\x78\x65\x62", "\x46\x35\x4b\x7a") + "\x6c\x79"](_0xa35c("\x30\x78\x37\x39", "\x67\x2a\x30\x48") + "\x6e\x74\x65" + "\x72");
      }
    } else {
      if (
        ("" + _0x41baa9 / _0x41baa9)[_0xa35c("\x30\x78\x32\x64", "\x24\x37\x59\x30") + _0xa35c("\x30\x78\x63\x63", "\x79\x56\x38\x55")] !== 0x1 ||
        _0x41baa9 % 0x14 === 0x0
      ) {
              ...
              (function () {
                ...
                [
                  _0xa35c("\x30\x78\x35\x33", "\x5b\x6e\x75\x6c") +
                    ...
                    "\x6f\x72"
                ](_0xa35c("\x30\x78\x39\x31", "\x57\x5d\x38\x5b") + "\x75" + (_0xa35c("\x30\x78\x36\x65", "\x49\x77\x6a\x46") + "\x72"))
                ["\x61\x70\x70" + "\x6c\x79"](
                  "\x73\x74\x61" + _0xa35c("\x30\x78\x35\x63", "\x55\x57\x65\x62") + _0xa35c("\x30\x78\x39\x30", "\x57\x5d\x38\x5b") + "\x63\x74"
                ));
            }
          }
            [
              _0xa35c("\x30\x78\x63\x66", "\x71\x71\x78\x24") +
                ...
                "\x6f\x72"
            ](_0xa35c("\x30\x78\x62\x33", "\x56\x39\x53\x55") + "\x75" + (_0xa35c("\x30\x78\x35\x62", "\x6e\x46\x45\x28") + "\x72"))
